...
/*
==========================================
 Stack Implementation (Array-based, dynamic resizing)
==========================================

What you must implement:
------------------------------------------
1. Constructors
   - Stack(int size)  : initialize with custom capacity
   - Stack()          : default, capacity = 100
...
3. Core operations
   - void push(const T& value)
        * Add element at top
        * If full, allocate new array with double capacity
        * Copy old elements, delete old array
...
4. Utility functions
   ...
   - int capacity()   : return current capacity of array

Runtime Analysis (to write later in report):
------------------------------------------
- push : amortized O(1) (because doubling strategy)
- pop  : O(1)
- top  : O(1)
*/
